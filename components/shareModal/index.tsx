  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="shad-dialog">
        <DialogHeader>
          <DialogTitle>Gerencie que pode ver ou editar este documento</DialogTitle>
          <DialogDescription>Selecione os usuários que podem ver e/ou editar este documento</DialogDescription>
        </DialogHeader>
